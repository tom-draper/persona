...
def test_gen_samples_peru_includes_location():
    sample = gen_samples("peru", N=1, seed=42)[0]
...
def test_gen_samples_israel_includes_location():
    sample = gen_samples("israel", N=1, seed=42)[0]
    assert "location" in sample


def test_gen_samples_kazakhstan_includes_ethnicity():
    sample = gen_samples("kazakhstan", N=1, seed=42)[0]
    assert "ethnicity" in sample
