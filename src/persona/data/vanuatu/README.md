...
- [National Population and Housing Census 2020, Vanuatu National Statistics Office (via Pacific Community) (2020)](https://sdd.spc.int/) — religion
- [Urban population (% of total population), World Bank (2025)](https://data.worldbank.org/indicator/SP.URB.TOTL.IN.ZS) — residence
- [World Marriage Data 2019, United Nations (2009)](https://www.un.org/development/desa/pd/data/world-marriage-data) — marital status
